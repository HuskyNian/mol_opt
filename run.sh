...
commands=(
  ...
  "python run.py graph_ga --oracles qed:1+jnk3:1+drd2:1+gsk3b:1+sa:1 --init_method random1"
  "python run.py graph_ga --oracles qed:1+jnk3:1+drd2:1+gsk3b:1+sa:1 --init_method best100 --seed 44 45 46"
